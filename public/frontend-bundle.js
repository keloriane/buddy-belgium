...
/* harmony import */ var _animation_gsap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./animation.gsap */ "./src/js/gsap/animation.gsap.js");


gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.registerPlugin((gsap_dist_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1___default()));

var heroTl = gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline();
...
/* harmony export */   "fadeInUpStagger": () => /* binding */ fadeInUpStagger,
/* harmony export */   "fadeInStagger": () => /* binding */ fadeInStagger,
/* harmony export */   "fadeInScale": () => /* binding */ fadeInScale,
/* harmony export */   "fadeIn": () => /* binding */ fadeIn,
/* harmony export */   "deScale": () => /* binding */ deScale,
/* harmony export */   "loaderReset": () => /* binding */ loaderReset,
/* harmony export */   "loaderInFrom": () => /* binding */ loaderInFrom,
/* harmony export */   "loaderInTo": () => /* binding */ loaderInTo,
/* harmony export */   "loaderAway": () => /* binding */ loaderAway
/* harmony export */ });
var fadeInUp = {
  autoAlpha: 0,
  duration: 0.3,
...
/* harmony import */ var _loader_gsap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./loader.gsap */ "./src/js/gsap/loader.gsap.js");
/* harmony import */ var _about_gsap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./about.gsap */ "./src/js/gsap/about.gsap.js");
/* harmony import */ var _home_gsap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./home.gsap */ "./src/js/gsap/home.gsap.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "animationHome": () => /* binding */ animationHome
/* harmony export */ });
...
/* harmony import */ var _animation_gsap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./animation.gsap */ "./src/js/gsap/animation.gsap.js");
...
var animationHome = {
  ...
  posts: function posts() {
    ...
    return tl.to('.nav-main', {
      opacity: 1
    }).to('.home-wrapper', {
      opacity: 1
    }).from('.home-wrapper article', _animation_gsap__WEBPACK_IMPORTED_MODULE_0__.fadeInStagger);
  },
  reinitialization: function reinitialization() {
    gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set('.home-wrapper', {
      opacity: 0
    });
    gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set('.nav-main', {
      opacity: 0
    });
  }
};
...
var animationLoader = {
  reset: function reset() {
    gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set('.loader', _animation_gsap__WEBPACK_IMPORTED_MODULE_0__.loaderReset);
  },
  loaderIn: function loaderIn() {
    var tl = gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.timeline({
      onComplete: animationLoader.loaderAway
    });
    tl.fromTo('.loader', _animation_gsap__WEBPACK_IMPORTED_MODULE_0__.loaderInFrom, _animation_gsap__WEBPACK_IMPORTED_MODULE_0__.loaderInTo);
  },
  loaderAway: function loaderAway() {
    gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to('.loader', _animation_gsap__WEBPACK_IMPORTED_MODULE_0__.loaderAway);
  }
};
...
function init() {
  ...
  gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_0___default().from('span h2', {
    duration: 0.5,
    y: 100,
    stagger: 0.13,
    scrollTrigger: {
  ...
  gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_0___default().from(['.inner-text  p', '.info-text p'], {
    duration: 0.5,
    opacity: 0,
    y: '80%',
    stagger: 0.15,
...
gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.registerPlugin(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger);
...
gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.addEventListener('refreshInit', setHeight);
gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(container, {
  y: function y() {
...
var swiper = new swiper__WEBPACK_IMPORTED_MODULE_7__.default('.product-list-container', {
  slidesPerView: 3,
  spaceBetween: 30,
  loop: true,
